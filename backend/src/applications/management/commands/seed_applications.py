...
SEED = [
    ...
    {
        "company": "QuintoAndar",
        "position": "Engenheiro(a) de Software Backend Sênior",
        "status": S.OFFER,
        "days": 3,
        "link": True,
        "cv": True,
    ...
    {
        "company": "CloudWalk",
        "position": "Backend Engineer (Python) - Pagamentos",
        "status": S.OFFER,
        "days": 6,
        "link": True,
        "cv": True,
    ...
    {
        "company": "Nubank",
        "position": "Software Engineer - Plataforma de Pagamentos",
        "status": S.FINAL_INTERVIEW,
        "days": 2,
        "link": True,
        "cv": True,
    ...
    {
        "company": "PicPay",
        "position": "Tech Lead Backend (Python)",
        "status": S.FINAL_INTERVIEW,
        "days": 5,
        "link": True,
        "cv": True,
    ...
    {
        "company": "Inter",
        "position": "Pessoa Desenvolvedora Backend Sênior",
        "status": S.FINAL_INTERVIEW,
        "days": 9,
        "link": False,
        "cv": False,
    ...
    {
        "company": "Stone",
        "position": "Desenvolvedor(a) Backend Sênior (Python)",
        "status": S.TECHNICAL_INTERVIEW,
        "days": 4,
        "link": True,
        "cv": True,
    ...
    },
    {
        ...
        "position": "Backend Developer Sr - Fintech",
        "status": S.TECHNICAL_INTERVIEW,
        "days": 7,
        "link": True,
        "cv": True,
    ...
    {
        "company": "Creditas",
        "position": "Engenheiro(a) de Software Backend",
        "status": S.TECHNICAL_INTERVIEW,
        "days": 8,
        "link": True,
        "cv": False,
    ...
    {
        "company": "Dock",
        "position": "Pessoa Engenheira Backend Sênior",
        "status": S.TECHNICAL_INTERVIEW,
        "days": 12,
        "link": False,
        "cv": True,
    ...
    {
        "company": "C6 Bank",
        "position": "Engenheiro(a) de Software - Core Banking",
        "status": S.SCREENING,
        "days": 6,
        "link": True,
        "cv": True,
    ...
    {
        "company": "PagBank",
        "position": "Backend Sênior (Python/Go)",
        "status": S.SCREENING,
        "days": 10,
        "link": True,
        "cv": False,
    ...
    {
        "company": "Neon",
        "position": "Pessoa Desenvolvedora Python Sênior",
        "status": S.SCREENING,
        "days": 11,
        "link": False,
        "cv": False,
    ...
    {
        "company": "Cora",
        "position": "Backend Engineer - Plataforma",
        "status": S.SCREENING,
        "days": 13,
        "link": True,
        "cv": True,
    ...
    {
        "company": "iFood",
        "position": "Software Engineer Backend - Logística",
        "status": S.APPLIED,
        "days": 1,
        "link": True,
        "cv": True,
    ...
    {
        "company": "Pismo",
        "position": "Backend Developer - Core",
        "status": S.APPLIED,
        "days": 8,
        "link": True,
        "cv": True,
    ...
    {
        "company": "Olist",
        "position": "Pessoa Desenvolvedora Backend Pleno/Sênior",
        "status": S.APPLIED,
        "days": 9,
        "link": True,
        "cv": False,
    ...
    {
        "company": "Loggi",
        "position": "Backend Engineer Sr - Roteirização",
        "status": S.REJECTED,
        "days": 18,
        "link": True,
        "cv": True,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        latest_version = ResumeVersion.objects.filter(resume__user=user).order_by("-version_number").first()
