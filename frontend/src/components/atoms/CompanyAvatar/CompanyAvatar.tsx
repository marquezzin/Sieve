 ...
 * determinística (hash do nome), então o avatar é estável entre renders e em
 * qualquer tela (vagas, candidaturas) — vivo sem virar arco-íris.
 */
...
interface CompanyAvatarProps {
  company: string;
  /** Lado do quadrado em px (default 42). */
  size?: number;
}

/**
 * Avatar quadrado com as iniciais da empresa, em gradiente quente determinístico
 * por empresa. Mesma empresa → mesmo gradiente em qualquer lugar do app. Átomo
