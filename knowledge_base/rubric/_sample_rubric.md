...
priority: always
tags: [rubric, scoring, sample]
---

# Rubrica de avaliação de currículo

Sistema de pontuação 0–10 por critério, pesos somam 1.0. Score final é média
ponderada. Notas abaixo de 5 disparam alerta crítico no breakdown.

## 1. Uso de verbos de ação (peso 0.15)

- **10**: 100% dos bullets começam com verbo de ação específico no passado.
- **7**: 80%+ dos bullets ok; 1–2 começam com "trabalhei", "ajudei".
...
- **10**: ≥70% dos bullets têm número, percentual, escala ou faixa.
- **7**: ~50% têm métrica.
- **5**: Métricas apenas em projeto pessoal ou em seção isolada.
- **0**: Nenhuma métrica em todo o currículo.

## 3. Ausência de clichês (peso 0.15)

Lista de bloqueio: "proativo", "dinâmico", "comunicativo", "bom em trabalho em
equipe", "facilidade pra aprender", "apaixonado por tecnologia", "hands-on".
...
- **10**: Tecnologias mencionadas com contexto (versão, escala, problema).
...
- **10**: Seções claras, hierarquia visual, sem caixas/tabelas exóticas que
  quebram ATS.
